      ...
      <div className="flex flex-col h-full py-8 justify-between">
        ...
        <div className="flex-1 mt-10 space-y-8 overflow-y-auto custom-scrollbar">
          ...
          <nav className="space-y-1">
            ...
            <div className={`flex items-center gap-4 text-on-surface-variant py-2.5 px-6 opacity-30 cursor-not-allowed ${collapsed ? 'justify-center px-0' : ''}`}>
              <span className="material-symbols-outlined text-[20px]">event_note</span>
              {!collapsed && <span className="text-sm font-medium">Planning</span>}
            </div>
            <div className={`flex items-center gap-4 text-on-surface-variant py-2.5 px-6 opacity-30 cursor-not-allowed ${collapsed ? 'justify-center px-0' : ''}`}>
            ...
            <div className={`flex items-center gap-4 text-on-surface-variant py-2.5 px-6 opacity-30 cursor-not-allowed ${collapsed ? 'justify-center px-0' : ''}`}>
              ...
              {!collapsed && <span className="text-sm font-medium">MVP</span>}
            </div>
