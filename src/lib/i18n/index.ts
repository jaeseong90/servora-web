...
const translations: TranslationMap = {
  ...
  'plan.questionDesc': { ko: '아래 질문에 답변해주시면 AI가 16항목 실무 기획안을 작성합니다. 구체적일수록 좋은 결과가 나옵니다.', en: 'Answer the questions below and AI will create a 16-section professional plan. The more specific, the better.' },
  'plan.generateNote': { ko: 'AI가 16항목 실무 기획안을 작성합니다. 약 1~2분 소요됩니다.', en: 'AI will generate a 16-section plan. This takes about 1-2 minutes.' },
