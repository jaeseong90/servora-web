...
const translations: TranslationMap = {
  ...
  // Design 4-Phase
  'design.phase.title': { ko: '디자인 단계', en: 'Design Phase' },
  'design.phase.brand': { ko: '분위기 선택', en: 'Style' },
  'design.phase.architecture': { ko: '서비스 구성', en: 'Structure' },
  'design.phase.screens': { ko: '화면별 상세', en: 'Screen Details' },
  'design.phase.final': { ko: '최종 확인', en: 'Final Review' },
  'design.phase.approved': { ko: '완료', en: 'Done' },
  'design.phase.review': { ko: '검토 중', en: 'Reviewing' },
  'design.phase.generating': { ko: '생성 중', en: 'Generating' },
  'design.phase.pending': { ko: '대기', en: 'Waiting' },
  'design.brand.selectStyle': { ko: '어떤 분위기의 서비스를 원하세요?', en: 'What style do you want?' },
  'design.brand.ready': { ko: '브랜드 시안이 준비되었어요', en: 'Brand proposal is ready' },
  'design.brand.approved': { ko: '브랜드 시안이 확정되었습니다', en: 'Brand has been approved' },
  'design.arch.ready': { ko: '서비스 구성이 준비되었어요', en: 'Service structure is ready' },
  'design.arch.approved': { ko: '서비스 구성이 확정되었습니다', en: 'Service structure has been approved' },
  'design.screen.progress': { ko: '화면별 상세 설계', en: 'Screen Details' },
  'design.screen.approved': { ko: '화면별 상세 설계가 확정되었습니다', en: 'Screen details have been approved' },
  'design.final.title': { ko: '최종 제작 청사진', en: 'Final Blueprint' },
  'design.final.start': { ko: 'MVP 제작 시작하기', en: 'Start MVP Production' },
  'design.final.finalizing': { ko: '최종 확정 중...', en: 'Finalizing...' },
  'design.approve': { ko: '좋아요, 진행해주세요', en: 'Looks good, proceed' },
  'design.regenerate': { ko: '다시 생성', en: 'Regenerate' },
  'design.feedback.placeholder': { ko: '수정하고 싶은 내용을 입력하세요...', en: 'Tell us what to change...' },
  'design.feedback.submit': { ko: '수정 요청', en: 'Request Change' },
  'design.locked': { ko: '디자인이 확정되었습니다', en: 'Design has been finalized' },
